...
<div class="box" style="padding: 15px">
	...
	<f:form action="update" method="post" modelAttribute="roomType">
		<f:hidden path="roomTypeId" />
		<div class="mb-4" style="margin-bottom: 15px">
			<label for="" class="form-label" style="margin-bottom: 10px">Type
				Name</label>
		...
		<div class="mb-4" style="margin-bottom: 15px">
			<label for="" class="form-label" style="margin-bottom: 10px">Max
				Occupancy</label>
