...
<div class="box" style="padding: 15px">
	<a href="<c:url value='/admin/facility/add' />" class="btn btn-primary">Thêm
		mới +</a>
	...
	<table class="table">
		...
		<tbody>
			<c:forEach items="${facilities }" var="f">
				<tr>
					<th scope="row" style="vertical-align: middle;">${f.facilityId }</th>
					<td style="vertical-align: middle;">${f.facilityName }</td>
					<td style="vertical-align: middle;"><a
						href="facility/edit?id=${f.facilityId }" class="btn btn-info">
							<i class="fa-regular fa-pen-to-square"></i>
					</a> <a onclick="return confirm('Bạn có chắc muốn xóa ?')"
						href="facility/delete?id=${f.facilityId}" class="btn btn-danger">
