...
<div class="box" style="padding: 15px">
	...
	<f:form action="update" method="post" modelAttribute="room"
		enctype="multipart/form-data">
		<f:hidden path="roomId" />
		<div class="row">
			<div class="col-lg-6">
				<div class="mb-4" style="margin-bottom: 15px">
					<label for="" class="form-label" style="margin-bottom: 10px">Room
						Id</label>
					<f:input path="roomId" class="form-control" disabled="true"></f:input>
			...
			<div class="col-lg-6">
				...
				<div class="mb-4" style="margin-bottom: 15px">
					...
					<img src="${pageContext.servletContext.contextPath}/resources/uploads/${room.image }" id="upload" width="200px"
